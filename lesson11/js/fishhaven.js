const apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=42.0380399&lon=-111.4048681&units=imperial&appid=290e5c7b68ca4a803da90608515efd48";
...
const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?lat=42.0380399&lon=-111.4048681&units=imperial&appid=290e5c7b68ca4a803da90608515efd48";
...
fetch(requestURL)
    ...
    .then(function (jsonObject) {
        ...
        towns = towns.filter(town => (town.name === 'Fish Haven'))
